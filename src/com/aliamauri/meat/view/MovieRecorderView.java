...
public class MovieRecorderView extends LinearLayout implements OnErrorListener {
	...
	public MovieRecorderView(Context context, AttributeSet attrs, int defStyle) {
		...
		mWidth = a.getInteger(R.styleable.MovieRecorderView_mrv_width, 320);// 默认320
		mHeight = a.getInteger(R.styleable.MovieRecorderView_mrv_height, 240);// 默认240

		isOpenCamera = a.getBoolean(
				R.styleable.MovieRecorderView_mrv_is_open_camera, true);// 默认打开
		mRecordMaxTime = a.getInteger(
				R.styleable.MovieRecorderView_mrv_record_max_time, 10);// 默认为10
