...
import com.aliamauri.meat.activity.IM.parse.ParseManager;
...
public class UserProfileManager {
	...
	private String getCurrentUserAvatar() {
		 String currentUserAvatar = PreferenceUtils.getInstance().getCurrentUserAvatar();
		 if (TextUtils.isEmpty(currentUserAvatar)) {
			currentUserAvatar=PrefUtils.getString(GlobalConstant.HEAD_ICON_PATH, null);
		}
