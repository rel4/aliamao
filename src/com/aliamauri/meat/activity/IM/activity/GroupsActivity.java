...
import com.aliamauri.meat.activity.IM.adapter.GroupAdapter;
...
public class GroupsActivity extends BaseActivity {
	...
	class SyncListener implements SDKHelper.HXSyncListener {
		@Override
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SDKHelper.getInstance().addSyncGroupListener(syncListener);
	...
	protected void onDestroy() {
		if (syncListener != null) {
			SDKHelper.getInstance().removeSyncGroupListener(syncListener);
			syncListener = null;
		}
		super.onDestroy();
		instance = null;
