...
import com.aliamauri.meat.activity.IM.adapter.NewFriendsMsgAdapter;
...
public class NewFriendsMsgActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		((MySDKHelper)SDKHelper.getInstance()).getContactList().get(Constant.NEW_FRIENDS_USERNAME).setUnreadMsgCount(0);
