...
public class ChatAllHistoryAdapter extends ArrayAdapter<EMConversation> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (conversation.getType() == EMConversationType.GroupChat) {
			...
			if (username.equals(Constant.GROUP_USERNAME)) {
				holder.name.setText(UIUtils.getContext().getResources().getString(R.string.group_chat));

			} else if (username.equals(Constant.NEW_FRIENDS_USERNAME)) {
				holder.name.setText(UIUtils.getContext().getResources().getString(R.string.new_friend));
			}else if (Constant.OFFICIAL_USER.equals(username)) {
				holder.name.setText(UIUtils.getContext().getResources().getString(R.string.official_user));
			}else if (Constant.APPOINTMENT_INVITATION.equals(username)) {
				holder.name.setText(UIUtils.getContext().getResources().getString(R.string.appointment_invitation));
			}
			Map<String,RobotUser> robotMap=((MySDKHelper)SDKHelper.getInstance()).getRobotList();
	...
	private String getMessageDigest(EMMessage message, Context context) {
		...
		case TXT: // 文本消息
			...
			if(((MySDKHelper)SDKHelper.getInstance()).isRobotMenuMessage(message)){
				digest = ((MySDKHelper)SDKHelper.getInstance()).getRobotMenuMessageDigest(message);
