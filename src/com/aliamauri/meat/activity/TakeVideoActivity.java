...
import com.aliamauri.meat.activity.IM.activity.BaseActivity;
...
public class TakeVideoActivity extends BaseActivity implements OnClickListener,
	...
	private void handleSurfaceChanged() {
		...
		if (resolutionList != null && resolutionList.size() > 0) {
			...
			for (int i = 0; i < resolutionList.size(); i++) {
				...
				LogUtil.e(this, "width   =  " + size.width + " :　　　height  =  "
						+ size.height);
			...
			if (!hasSize) {
				...
				previewWidth = previewSize.width;
				previewHeight = previewSize.height;
				LogUtil.e(RecorderVideoActivity.class, "previewWidth   =  "
						+ previewWidth);
				LogUtil.e(RecorderVideoActivity.class, "previewHeight  =  "
						+ previewHeight);
	...
	public static void setCameraDisplayOrientation(Activity activity,
		...
		int result;
		LogUtil.e("DisplayOrientatio", "DisplayOrientatio前： " + degrees);
		...
		LogUtil.e("DisplayOrientatio", "DisplayOrientatio后result： " + result);
	...
	public void onClick(View view) {
		...
		case R.id.recorder_send:
			...
			if (file.exists()) {
				...
				UIUtils.showToast(UIUtils.getContext(), "文件损坏或拍摄时间过短");
				startActivity(new Intent(TakeVideoActivity.this,
						TakeVideoActivity.class));
			}
			finish();
	...
	private boolean initRecorder() {
		...
		LogUtil.e(RecorderVideoActivity.class, "mediaRecorder  previewWidth = "
