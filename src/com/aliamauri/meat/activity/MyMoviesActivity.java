...
public class MyMoviesActivity extends BaseActivity implements OnClickListener {
			...
			ptg_amymovies_list
					.setOnItemClickListener(new OnItemClickListener() {
						...
						public void onItemClick(AdapterView<?> parent,
							...
							new AlertDialog.Builder(MyMoviesActivity.this)
									.setMessage(
											"是否确定删除"
													+ myVideoBean.cont
															.get(position).name)
		...
		public View getView(final int position, View convertView,
			...
			convertView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					Intent intent = new Intent(MyMoviesActivity.this,
							PlayActivity.class);
					intent.putExtra(GlobalConstant.PLAY_VIDEO_ID,
							myVideoBean.cont.get(position).id);
					MyMoviesActivity.this.startActivity(intent);
				}
			});
			return convertView;
		}
