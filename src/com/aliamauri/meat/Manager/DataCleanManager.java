...
public class DataCleanManager {
	...
	private static final DataCleanManager dcm = new DataCleanManager();
     ...
     * @param context
     */
    private void cleanDB_data(Context context) {
		DynamicShowDao.getInstance().deleteAllData();
	}
	/**
